...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'FoodPantry.id'
        db.delete_column('qhmobile_foodpantry', 'id')

        # Deleting field 'FoodPantry.address'
        db.delete_column('qhmobile_foodpantry', 'address')

        # Adding field 'FoodPantry.address_ptr'
        db.add_column('qhmobile_foodpantry', 'address_ptr',
                      self.gf('django.db.models.fields.related.OneToOneField')(default=None, to=orm['easy_maps.Address'], unique=True, primary_key=True),
                      keep_default=False)


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'FoodPantry.id'
        raise RuntimeError("Cannot reverse this migration. 'FoodPantry.id' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'FoodPantry.address'
        raise RuntimeError("Cannot reverse this migration. 'FoodPantry.address' and its values cannot be restored.")
        # Deleting field 'FoodPantry.address_ptr'
        db.delete_column('qhmobile_foodpantry', 'address_ptr_id')
