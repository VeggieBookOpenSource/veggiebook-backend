...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'FoodStuff.image'
        db.alter_column('qhmobile_foodstuff', 'image_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['qhmobile.StockPhoto']))

        # Changing field 'TipDoc.image'
        db.alter_column('qhmobile_tipdoc', 'image_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['qhmobile.StockPhoto']))

    def backwards(self, orm):

        # Changing field 'FoodStuff.image'
        db.alter_column('qhmobile_foodstuff', 'image_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['qhmobile.StockPhoto'], null=True))

        # Changing field 'TipDoc.image'
        db.alter_column('qhmobile_tipdoc', 'image_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['qhmobile.StockPhoto'], null=True))
