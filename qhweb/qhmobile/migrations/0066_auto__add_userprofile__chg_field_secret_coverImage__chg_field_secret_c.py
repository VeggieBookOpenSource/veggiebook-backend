...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'qhmobile_userprofile', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True)),
            ('deviceId', self.gf('django.db.models.fields.TextField')(max_length=38, null=True)),
        ))
        db.send_create_signal(u'qhmobile', ['UserProfile'])


        # Changing field 'Secret.coverImage'
        db.alter_column(u'qhmobile_secret', 'coverImage_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['qhmobile.CoverPhoto'], null=True, on_delete=models.PROTECT))

        # Changing field 'Secret.coverImage_es'
        db.alter_column(u'qhmobile_secret', 'coverImage_es_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.PROTECT, to=orm['qhmobile.CoverPhoto']))

    def backwards(self, orm):
        # Deleting model 'UserProfile'
        db.delete_table(u'qhmobile_userprofile')


        # Changing field 'Secret.coverImage'
        db.alter_column(u'qhmobile_secret', 'coverImage_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['qhmobile.CoverPhoto'], null=True))

        # Changing field 'Secret.coverImage_es'
        db.alter_column(u'qhmobile_secret', 'coverImage_es_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['qhmobile.CoverPhoto']))
