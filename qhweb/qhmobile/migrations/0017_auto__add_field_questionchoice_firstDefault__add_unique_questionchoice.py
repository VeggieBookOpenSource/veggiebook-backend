...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'QuestionChoice.firstDefault'
        db.add_column('qhmobile_questionchoice', 'firstDefault',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding unique constraint on 'QuestionChoice', fields ['attribute']
        db.create_unique('qhmobile_questionchoice', ['attribute_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'QuestionChoice', fields ['attribute']
        db.delete_unique('qhmobile_questionchoice', ['attribute_id'])

        # Deleting field 'QuestionChoice.firstDefault'
        db.delete_column('qhmobile_questionchoice', 'firstDefault')
