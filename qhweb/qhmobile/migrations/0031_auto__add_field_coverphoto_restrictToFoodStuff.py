...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('qhmobile_coverphoto', 'restrictToFoodStuff',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='+', null=True, to=orm['qhmobile.FoodStuff']),
                      keep_default=False)
    ...
    models = {
        ...
        'qhmobile.coverphoto': {
            ...
            'restrictToFoodStuff': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'+'", 'null': 'True', 'to': "orm['qhmobile.FoodStuff']"})
        },
        'qhmobile.foodpantry': {
