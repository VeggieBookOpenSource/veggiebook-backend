...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'FoodTip.index'
        db.delete_column('qhmobile_foodtip', 'index')

        # Adding field 'FoodTip.fsIndex'
        db.add_column('qhmobile_foodtip', 'fsIndex',
                      self.gf('django.db.models.fields.IntegerField')(default=10000),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'FoodTip.index'
        db.add_column('qhmobile_foodtip', 'index',
                      self.gf('django.db.models.fields.IntegerField')(default=10000),
                      keep_default=False)

        # Deleting field 'FoodTip.fsIndex'
        db.delete_column('qhmobile_foodtip', 'fsIndex')
    ...
    models = {
        ...
        'qhmobile.foodtip': {
            'Meta': {'ordering': "('fsIndex', 'id')", 'object_name': 'FoodTip'},
