...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Secret.coverImage'
        db.add_column('qhmobile_secret', 'coverImage',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['qhmobile.CoverPhoto'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Secret.coverImage'
        db.delete_column('qhmobile_secret', 'coverImage_id')
