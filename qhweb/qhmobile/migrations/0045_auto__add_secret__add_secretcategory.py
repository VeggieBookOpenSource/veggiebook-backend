...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Secret'
        db.create_table('qhmobile_secret', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('title', self.gf('django.db.models.fields.related.ForeignKey')(related_name='secretTitle', to=orm['qhmobile.String'])),
            ('category', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['qhmobile.SecretCategory'])),
            ('isActive', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('image', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True)),
            ('secret', self.gf('django.db.models.fields.related.ForeignKey')(related_name='secretText', to=orm['qhmobile.String'])),
            ('whyItWorks', self.gf('django.db.models.fields.related.ForeignKey')(related_name='whyItWorks', to=orm['qhmobile.String'])),
        ))
        db.send_create_signal('qhmobile', ['Secret'])

        # Adding model 'SecretCategory'
        db.create_table('qhmobile_secretcategory', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('title', self.gf('django.db.models.fields.related.ForeignKey')(related_name='secretCategory', to=orm['qhmobile.String'])),
            ('image', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True)),
        ))
        db.send_create_signal('qhmobile', ['SecretCategory'])


    def backwards(self, orm):
        # Deleting model 'Secret'
        db.delete_table('qhmobile_secret')

        # Deleting model 'SecretCategory'
        db.delete_table('qhmobile_secretcategory')
