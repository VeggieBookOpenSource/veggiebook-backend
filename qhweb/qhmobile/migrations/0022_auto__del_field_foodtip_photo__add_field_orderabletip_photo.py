...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'FoodTip.photo'
        db.delete_column('qhmobile_foodtip', 'photo_id')

        # Adding field 'OrderableTip.photo'
        db.add_column('qhmobile_orderabletip', 'photo',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['qhmobile.Photo'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'FoodTip.photo'
        db.add_column('qhmobile_foodtip', 'photo',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['qhmobile.Photo'], null=True, blank=True),
                      keep_default=False)

        # Deleting field 'OrderableTip.photo'
        db.delete_column('qhmobile_orderabletip', 'photo_id')
