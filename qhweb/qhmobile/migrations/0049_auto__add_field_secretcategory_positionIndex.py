...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SecretCategory.positionIndex'
        db.add_column('qhmobile_secretcategory', 'positionIndex',
                      self.gf('django.db.models.fields.IntegerField')(default=100),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SecretCategory.positionIndex'
        db.delete_column('qhmobile_secretcategory', 'positionIndex')
