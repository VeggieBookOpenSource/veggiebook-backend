...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ViewingData.book_id'
        db.add_column('qhmobile_viewingdata', 'book_id',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=56),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ViewingData.book_id'
        db.delete_column('qhmobile_viewingdata', 'book_id')
