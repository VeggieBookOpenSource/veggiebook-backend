...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('qhmobile_coverphoto', (
        ...
        db.send_create_signal('qhmobile', ['CoverPhoto'])

        # Adding model 'RecipeBook'
        db.create_table('qhmobile_recipebook', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('coverPhoto', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['qhmobile.CoverPhoto'])),
        ))
        db.send_create_signal('qhmobile', ['RecipeBook'])

        # Adding M2M table for field attributes on 'RecipeBook'
        db.create_table('qhmobile_recipebook_attributes', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('recipebook', models.ForeignKey(orm['qhmobile.recipebook'], null=False)),
            ('attribute', models.ForeignKey(orm['qhmobile.attribute'], null=False))
        ))
        db.create_unique('qhmobile_recipebook_attributes', ['recipebook_id', 'attribute_id'])

        # Adding M2M table for field recipes on 'RecipeBook'
        db.create_table('qhmobile_recipebook_recipes', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('recipebook', models.ForeignKey(orm['qhmobile.recipebook'], null=False)),
            ('recipe', models.ForeignKey(orm['qhmobile.recipe'], null=False))
        ))
        db.create_unique('qhmobile_recipebook_recipes', ['recipebook_id', 'recipe_id'])


    def backwards(self, orm):
        # Deleting model 'CoverPhoto'
        db.delete_table('qhmobile_coverphoto')

        # Deleting model 'RecipeBook'
        db.delete_table('qhmobile_recipebook')

        # Removing M2M table for field attributes on 'RecipeBook'
        db.delete_table('qhmobile_recipebook_attributes')

        # Removing M2M table for field recipes on 'RecipeBook'
        db.delete_table('qhmobile_recipebook_recipes')
    ...
    models = {
        ...
        'qhmobile.recipebook': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'recipes': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['qhmobile.Recipe']", 'symmetrical': 'False'}),
