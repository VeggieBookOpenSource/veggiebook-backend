...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SecretBook.latitude'
        db.add_column('qhmobile_secretbook', 'latitude',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'SecretBook.longitude'
        db.add_column('qhmobile_secretbook', 'longitude',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'RecipeBook.latitude'
        db.add_column('qhmobile_recipebook', 'latitude',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'RecipeBook.longitude'
        db.add_column('qhmobile_recipebook', 'longitude',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SecretBook.latitude'
        db.delete_column('qhmobile_secretbook', 'latitude')

        # Deleting field 'SecretBook.longitude'
        db.delete_column('qhmobile_secretbook', 'longitude')

        # Deleting field 'RecipeBook.latitude'
        db.delete_column('qhmobile_recipebook', 'latitude')

        # Deleting field 'RecipeBook.longitude'
        db.delete_column('qhmobile_recipebook', 'longitude')
