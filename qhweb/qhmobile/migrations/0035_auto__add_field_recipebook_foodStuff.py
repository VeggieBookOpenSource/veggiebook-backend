...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'RecipeBook.foodStuff'
        db.add_column('qhmobile_recipebook', 'foodStuff',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['qhmobile.FoodStuff'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'RecipeBook.foodStuff'
        db.delete_column('qhmobile_recipebook', 'foodStuff_id')
