...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'OrderableTip'
        db.create_table('qhmobile_orderabletip', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('tipId', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['qhmobile.FoodTip'])),
        ...
        db.send_create_signal('qhmobile', ['OrderableTip'])


    def backwards(self, orm):
        # Deleting model 'OrderableTip'
        db.delete_table('qhmobile_orderabletip')
