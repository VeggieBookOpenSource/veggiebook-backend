...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'RecipeNote'
        db.create_table('qhmobile_recipenote', (
        ...
        db.send_create_signal('qhmobile', ['RecipeNote'])


    def backwards(self, orm):
        # Deleting model 'RecipeNote'
        db.delete_table('qhmobile_recipenote')
