...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ViewingData.timeStamp'
        db.alter_column('qhmobile_viewingdata', 'timeStamp', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

    def backwards(self, orm):

        # Changing field 'ViewingData.timeStamp'
        db.alter_column('qhmobile_viewingdata', 'timeStamp', self.gf('django.db.models.fields.DateTimeField')())
