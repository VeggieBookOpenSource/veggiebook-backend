...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'CoverPhoto.restrictToFoodStuff'
        db.delete_column('qhmobile_coverphoto', 'restrictToFoodStuff_id')

        # Adding field 'CoverPhoto.restrictTo'
        db.add_column('qhmobile_coverphoto', 'restrictTo',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['qhmobile.FoodStuff'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'CoverPhoto.restrictToFoodStuff'
        db.add_column('qhmobile_coverphoto', 'restrictToFoodStuff',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', null=True, to=orm['qhmobile.FoodStuff'], blank=True),
                      keep_default=False)

        # Deleting field 'CoverPhoto.restrictTo'
        db.delete_column('qhmobile_coverphoto', 'restrictTo_id')
