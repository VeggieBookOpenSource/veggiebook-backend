...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Secret.attachment'
        db.delete_column('qhmobile_secret', 'attachment')

        # Adding field 'Secret.attachment_en'
        db.add_column('qhmobile_secret', 'attachment_en',
                      self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Secret.attachment_es'
        db.add_column('qhmobile_secret', 'attachment_es',
                      self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Secret.attachment'
        db.add_column('qhmobile_secret', 'attachment',
                      self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Secret.attachment_en'
        db.delete_column('qhmobile_secret', 'attachment_en')

        # Deleting field 'Secret.attachment_es'
        db.delete_column('qhmobile_secret', 'attachment_es')
