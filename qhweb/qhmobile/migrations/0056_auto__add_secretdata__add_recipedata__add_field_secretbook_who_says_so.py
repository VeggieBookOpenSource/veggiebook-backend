...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'SecretBook.who_says_so_viewed'
        db.add_column('qhmobile_secretbook', 'who_says_so_viewed',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'SecretBookSelection.scrolled'
        db.add_column('qhmobile_secretbookselection', 'scrolled',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'RecipeBookSelection.scrolled'
        db.add_column('qhmobile_recipebookselection', 'scrolled',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'SecretBook.who_says_so_viewed'
        db.delete_column('qhmobile_secretbook', 'who_says_so_viewed')

        # Deleting field 'SecretBookSelection.scrolled'
        db.delete_column('qhmobile_secretbookselection', 'scrolled')

        # Deleting field 'RecipeBookSelection.scrolled'
        db.delete_column('qhmobile_recipebookselection', 'scrolled')
