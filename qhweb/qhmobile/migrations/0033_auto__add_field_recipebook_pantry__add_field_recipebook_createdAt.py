...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'RecipeBook.pantry'
        db.add_column('qhmobile_recipebook', 'pantry',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['qhmobile.FoodPantry'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'RecipeBook.createdAt'
        db.add_column('qhmobile_recipebook', 'createdAt',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2013, 3, 19, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'RecipeBook.pantry'
        db.delete_column('qhmobile_recipebook', 'pantry_id')

        # Deleting field 'RecipeBook.createdAt'
        db.delete_column('qhmobile_recipebook', 'createdAt')
