...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Question.subIntro'
        db.add_column('qhmobile_question', 'subIntro',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='subintro', null=True, to=orm['qhmobile.String']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Question.subIntro'
        db.delete_column('qhmobile_question', 'subIntro_id')
