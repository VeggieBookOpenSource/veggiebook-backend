...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field selections on 'RecipeBook'
        db.create_table('qhmobile_recipebook_selections', (
        ...
        db.create_unique('qhmobile_recipebook_selections', ['recipebook_id', 'recipebookselection_id'])
    ...
    def backwards(self, orm):
        ...
        db.create_unique('qhmobile_recipebook_recipes', ['recipebook_id', 'recipebookselection_id'])

        # Removing M2M table for field selections on 'RecipeBook'
        db.delete_table('qhmobile_recipebook_selections')
