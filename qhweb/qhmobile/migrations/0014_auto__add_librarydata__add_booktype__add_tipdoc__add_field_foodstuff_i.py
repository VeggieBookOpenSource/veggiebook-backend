...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'LibraryData'
        db.create_table('qhmobile_librarydata', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('version', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, db_index=True, blank=True)),
        ))
        db.send_create_signal('qhmobile', ['LibraryData'])

        # Adding model 'BookType'
        db.create_table('qhmobile_booktype', (
            ('id', self.gf('django.db.models.fields.CharField')(max_length=24, primary_key=True)),
        ))
        db.send_create_signal('qhmobile', ['BookType'])

        # Adding model 'TipDoc'
        db.create_table('qhmobile_tipdoc', (
            ('id', self.gf('django.db.models.fields.CharField')(max_length=24, primary_key=True)),
            ('nameString', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['qhmobile.String'])),
            ('active', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('image', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['qhmobile.StockPhoto'], null=True, blank=True)),
        ))
        db.send_create_signal('qhmobile', ['TipDoc'])

        # Adding field 'FoodStuff.image'
        db.add_column('qhmobile_foodstuff', 'image',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['qhmobile.StockPhoto'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'LibraryData'
        db.delete_table('qhmobile_librarydata')

        # Deleting model 'BookType'
        db.delete_table('qhmobile_booktype')

        # Deleting model 'TipDoc'
        db.delete_table('qhmobile_tipdoc')

        # Deleting field 'FoodStuff.image'
        db.delete_column('qhmobile_foodstuff', 'image_id')
