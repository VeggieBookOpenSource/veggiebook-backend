...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Secret.image_es'
        db.add_column('qhmobile_secret', 'image_es',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Secret.coverImage_es'
        db.add_column('qhmobile_secret', 'coverImage_es',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='coverImage_es', null=True, to=orm['qhmobile.CoverPhoto']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Secret.image_es'
        db.delete_column('qhmobile_secret', 'image_es')

        # Deleting field 'Secret.coverImage_es'
        db.delete_column('qhmobile_secret', 'coverImage_es_id')
