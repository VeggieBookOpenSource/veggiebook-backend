...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SecretCategory.color'
        db.add_column('qhmobile_secretcategory', 'color',
                      self.gf('django.db.models.fields.CharField')(default='69d0ee', max_length=6),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SecretCategory.color'
        db.delete_column('qhmobile_secretcategory', 'color')
