...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FoodPantry.printer_name'
        db.add_column('qhmobile_foodpantry', 'printer_name',
                      self.gf('django.db.models.fields.CharField')(max_length=48, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'FoodPantry.printer_name'
        db.delete_column('qhmobile_foodpantry', 'printer_name')
