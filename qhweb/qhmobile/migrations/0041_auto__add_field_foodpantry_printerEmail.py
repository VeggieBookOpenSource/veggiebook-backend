...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FoodPantry.printerEmail'
        db.add_column('qhmobile_foodpantry', 'printerEmail',
                      self.gf('django.db.models.fields.EmailField')(default='tdi2048cynp656@print.epsonconnect.com', max_length=75),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'FoodPantry.printerEmail'
        db.delete_column('qhmobile_foodpantry', 'printerEmail')
