...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ViewingData.recipeBook'
        db.add_column('qhmobile_viewingdata', 'recipeBook',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['qhmobile.RecipeBook'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'ViewingData.secretBook'
        db.add_column('qhmobile_viewingdata', 'secretBook',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['qhmobile.SecretBook'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ViewingData.recipeBook'
        db.delete_column('qhmobile_viewingdata', 'recipeBook_id')

        # Deleting field 'ViewingData.secretBook'
        db.delete_column('qhmobile_viewingdata', 'secretBook_id')
    ...
    models = {
        ...
        'qhmobile.viewingdata': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'recipe': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['qhmobile.Recipe']", 'null': 'True', 'blank': 'True'}),
            'recipeBook': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['qhmobile.RecipeBook']", 'null': 'True', 'blank': 'True'}),
            'secret': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['qhmobile.Secret']", 'null': 'True', 'blank': 'True'}),
            'secretBook': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['qhmobile.SecretBook']", 'null': 'True', 'blank': 'True'}),
