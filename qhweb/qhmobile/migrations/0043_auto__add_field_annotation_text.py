...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Annotation.text'
        db.add_column('qhmobile_annotation', 'text',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='annotation', to=orm['qhmobile.String']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Annotation.text'
        db.delete_column('qhmobile_annotation', 'text_id')
