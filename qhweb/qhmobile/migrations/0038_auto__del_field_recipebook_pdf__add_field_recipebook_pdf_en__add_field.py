...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'RecipeBook.pdf'
        db.delete_column('qhmobile_recipebook', 'pdf')

        # Adding field 'RecipeBook.pdf_en'
        db.add_column('qhmobile_recipebook', 'pdf_en',
                      self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'RecipeBook.pdf_es'
        db.add_column('qhmobile_recipebook', 'pdf_es',
                      self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'RecipeBook.pdf'
        db.add_column('qhmobile_recipebook', 'pdf',
                      self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'RecipeBook.pdf_en'
        db.delete_column('qhmobile_recipebook', 'pdf_en')

        # Deleting field 'RecipeBook.pdf_es'
        db.delete_column('qhmobile_recipebook', 'pdf_es')
