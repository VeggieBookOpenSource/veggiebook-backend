...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        u, created = orm['auth.User'].objects.get_or_create(username="secrets_cover")
        for secret in orm.Secret.objects.all():
            cp = orm.CoverPhoto(img=secret.image, owner=u)
            cp.save()
            secret.coverImage = cp
            secret.save()
