...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'SecretBook'
        db.create_table('qhmobile_secretbook', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('coverPhoto', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['qhmobile.CoverPhoto'])),
            ('pantry', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['qhmobile.FoodPantry'], null=True, blank=True)),
            ('createdAt', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('category', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['qhmobile.SecretCategory'], null=True, blank=True)),
            ('pdf_en', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True)),
            ('pdf_es', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True)),
        ))
        db.send_create_signal('qhmobile', ['SecretBook'])

        # Adding M2M table for field selections on 'SecretBook'
        db.create_table('qhmobile_secretbook_selections', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('secretbook', models.ForeignKey(orm['qhmobile.secretbook'], null=False)),
            ('recipebookselection', models.ForeignKey(orm['qhmobile.recipebookselection'], null=False))
        ))
        db.create_unique('qhmobile_secretbook_selections', ['secretbook_id', 'recipebookselection_id'])

        # Adding model 'SecretBookSelection'
        db.create_table('qhmobile_secretbookselection', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('secret', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['qhmobile.Secret'])),
            ('selected', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('extras', self.gf('django.db.models.fields.IntegerField')(default=0)),
        ))
        db.send_create_signal('qhmobile', ['SecretBookSelection'])


    def backwards(self, orm):
        # Deleting model 'SecretBook'
        db.delete_table('qhmobile_secretbook')

        # Removing M2M table for field selections on 'SecretBook'
        db.delete_table('qhmobile_secretbook_selections')

        # Deleting model 'SecretBookSelection'
        db.delete_table('qhmobile_secretbookselection')
    ...
    models = {
        ...
        'qhmobile.secretbook': {
            ...
            'category': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['qhmobile.SecretCategory']", 'null': 'True', 'blank': 'True'}),
            'coverPhoto': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['qhmobile.CoverPhoto']"}),
            'createdAt': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'pantry': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['qhmobile.FoodPantry']", 'null': 'True', 'blank': 'True'}),
        ...
        'qhmobile.secretbookselection': {
            'Meta': {'object_name': 'SecretBookSelection'},
            'extras': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'secret': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['qhmobile.Secret']"}),
            'selected': ('django.db.models.fields.BooleanField', [], {'default': 'True'})
        },
