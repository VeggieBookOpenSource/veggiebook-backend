...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'RecipeBookSelection'
        db.create_table('qhmobile_recipebookselection', (
        ...
        db.send_create_signal('qhmobile', ['RecipeBookSelection'])


    def backwards(self, orm):
        # Deleting model 'RecipeBookSelection'
        db.delete_table('qhmobile_recipebookselection')
    ...
    models = {
        ...
        'qhmobile.recipebook': {
            ...
            'recipes': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['qhmobile.RecipeBookSelection']", 'symmetrical': 'False'}),
