...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ExternalLink.linkString'
        db.add_column('qhmobile_externallink', 'linkString',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=True, to=orm['qhmobile.String'], blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ExternalLink.linkString'
        db.delete_column('qhmobile_externallink', 'linkString_id')
    ...
    models = {
        ...
        'qhmobile.externallink': {
            ...
            'linkString': ('django.db.models.fields.related.ForeignKey', [], {'default': 'True', 'to': "orm['qhmobile.String']", 'blank': 'True'}),
            'linkText': ('django.db.models.fields.CharField', [], {'max_length': '120'}),
