...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'FoodTip'
        db.create_table('qhmobile_foodtip', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('heading', self.gf('django.db.models.fields.related.ForeignKey')(related_name='heading', to=orm['qhmobile.String'])),
            ('foodStuff', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['qhmobile.FoodStuff'])),
            ('photo', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['qhmobile.Photo'], null=True, blank=True)),
            ('requirement', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['qhmobile.OrRequirement'])),
        ))
        db.send_create_signal('qhmobile', ['FoodTip'])


    def backwards(self, orm):
        # Deleting model 'FoodTip'
        db.delete_table('qhmobile_foodtip')
