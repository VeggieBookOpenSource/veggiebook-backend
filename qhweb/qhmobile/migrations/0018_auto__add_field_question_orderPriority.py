...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Question.orderPriority'
        db.add_column('qhmobile_question', 'orderPriority',
                      self.gf('django.db.models.fields.IntegerField')(default=100),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Question.orderPriority'
        db.delete_column('qhmobile_question', 'orderPriority')
