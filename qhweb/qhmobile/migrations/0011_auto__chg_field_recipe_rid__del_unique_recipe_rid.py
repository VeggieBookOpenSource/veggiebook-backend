...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'Recipe', fields ['rid']
        db.delete_unique('qhmobile_recipe', ['rid'])


        # Changing field 'Recipe.rid'
        db.alter_column('qhmobile_recipe', 'rid', self.gf('django.db.models.fields.CharField')(max_length=6, null=True))

    def backwards(self, orm):

        # Changing field 'Recipe.rid'
        db.alter_column('qhmobile_recipe', 'rid', self.gf('django.db.models.fields.CharField')(default='', max_length=6, unique=True))
        # Adding unique constraint on 'Recipe', fields ['rid']
        db.create_unique('qhmobile_recipe', ['rid'])
