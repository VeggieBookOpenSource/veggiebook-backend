...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Annotation.img'
        db.delete_column('qhmobile_annotation', 'img')

        # Adding field 'Annotation.en_img'
        db.add_column('qhmobile_annotation', 'en_img',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='en_img', null=True, to=orm['qhmobile.StockPhoto']),
                      keep_default=False)

        # Adding field 'Annotation.es_img'
        db.add_column('qhmobile_annotation', 'es_img',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='es_img', null=True, to=orm['qhmobile.StockPhoto']),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Annotation.img'
        db.add_column('qhmobile_annotation', 'img',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Annotation.en_img'
        db.delete_column('qhmobile_annotation', 'en_img_id')

        # Deleting field 'Annotation.es_img'
        db.delete_column('qhmobile_annotation', 'es_img_id')
