...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting model 'SecretData'
        db.delete_table('qhmobile_secretdata')

        # Deleting model 'RecipeData'
        db.delete_table('qhmobile_recipedata')

        # Adding model 'ViewingData'
        db.create_table('qhmobile_viewingdata', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('timeStamp', self.gf('django.db.models.fields.DateTimeField')()),
            ('type', self.gf('django.db.models.fields.CharField')(max_length=1)),
            ('recipe', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['qhmobile.Recipe'], null=True)),
            ('secret', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['qhmobile.Secret'], null=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('event', self.gf('django.db.models.fields.CharField')(max_length=1)),
            ('data', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
        ))
        db.send_create_signal('qhmobile', ['ViewingData'])


    def backwards(self, orm):
        # Adding model 'SecretData'
        db.create_table('qhmobile_secretdata', (
            ('timeStamp', self.gf('django.db.models.fields.DateTimeField')()),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal('qhmobile', ['SecretData'])

        # Adding model 'RecipeData'
        db.create_table('qhmobile_recipedata', (
            ('timeStamp', self.gf('django.db.models.fields.DateTimeField')()),
            ('recipe', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['qhmobile.Recipe'])),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('data', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('event', self.gf('django.db.models.fields.CharField')(max_length=1)),
        ))
        db.send_create_signal('qhmobile', ['RecipeData'])

        # Deleting model 'ViewingData'
        db.delete_table('qhmobile_viewingdata')
    ...
    models = {
        ...
        'qhmobile.externallink': {
            'Meta': {'object_name': 'ExternalLink'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'language': ('django.db.models.fields.CharField', [], {'max_length': '2'}),
            'linkString': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['qhmobile.String']"}),
        ...
        'qhmobile.secret': {
            ...
            'coverImage': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['qhmobile.CoverPhoto']", 'null': 'True', 'blank': 'True'}),
            'coverImage_es': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'coverImage_es'", 'null': 'True', 'to': "orm['qhmobile.CoverPhoto']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'qhmobile.secretbook': {
            ...
            'pdf_en': ('django.db.models.fields.files.FileField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'pdf_es': ('django.db.models.fields.files.FileField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'selections': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['qhmobile.SecretBookSelection']", 'symmetrical': 'False'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']"}),
        ...
        'qhmobile.viewingdata': {
            'Meta': {'object_name': 'ViewingData'},
            'data': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'event': ('django.db.models.fields.CharField', [], {'max_length': '1'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'recipe': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['qhmobile.Recipe']", 'null': 'True'}),
            'secret': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['qhmobile.Secret']", 'null': 'True'}),
