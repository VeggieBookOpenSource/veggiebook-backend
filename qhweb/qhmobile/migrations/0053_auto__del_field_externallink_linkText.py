...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ExternalLink.linkText'
        db.delete_column('qhmobile_externallink', 'linkText')


    def backwards(self, orm):
        # Adding field 'ExternalLink.linkText'
        db.add_column('qhmobile_externallink', 'linkText',
                      self.gf('django.db.models.fields.CharField')(default='blah', max_length=120),
                      keep_default=False)
