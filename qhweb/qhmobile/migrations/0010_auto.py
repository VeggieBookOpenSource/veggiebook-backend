...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'String', fields ['needsTranslation']
        db.create_index('qhmobile_string', ['needsTranslation'])


    def backwards(self, orm):
        # Removing index on 'String', fields ['needsTranslation']
        db.delete_index('qhmobile_string', ['needsTranslation'])
