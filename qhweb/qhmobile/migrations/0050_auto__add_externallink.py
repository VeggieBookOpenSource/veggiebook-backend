...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('qhmobile_externallink', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('secret', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['qhmobile.Secret'])),
            ('linkText', self.gf('django.db.models.fields.CharField')(max_length=120)),
            ('language', self.gf('django.db.models.fields.CharField')(max_length=2)),
            ('url', self.gf('django.db.models.fields.URLField')(max_length=200)),
        ))
        db.send_create_signal('qhmobile', ['ExternalLink'])


    def backwards(self, orm):
        # Deleting model 'ExternalLink'
        db.delete_table('qhmobile_externallink')
